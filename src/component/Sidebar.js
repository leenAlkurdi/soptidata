...
const Sidebar = () => {
  return (
    <div className="shadow-[-5px_0_10px_10px_inset_rgba(0,0,0,0.2)] bg-[#4ac776] text-gray-800 h-screen p-6 shadow-2xl w-full sm:w-1/4 md:w-1/6 lg:w-1/6 rounded-tr-2xl ">
      <h2 className="font-bold mt-8 mb-20 ml-10 text-[#0e5c2a]">
        ...
        <p className="mt-12 text-white text-3xl mb-2">Details for user</p>
